package com.eenet.androidbase.widget.imageloader.glide.transformation;
...
public class GlideRoundImage implements Transformation<Bitmap> {
    ...
    public GlideRoundImage(Context context, int radius) {
        this(context, radius, 0);
    }

    public GlideRoundImage(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public GlideRoundImage(BitmapPool pool, int radius, int margin) {
