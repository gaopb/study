...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "EENET";
    ...
    public static <T> void save2Object(Context context , T object ){
        if(object==null)
            return;
        SharedPreferences.Editor ed = context.getSharedPreferences(PREFERENCE_NAME,Context.MODE_PRIVATE).edit();
    ...
    public static  <T> T get2Object(Context context   , Class<T> classOfT){
        String jsonStr =context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE).getString(classOfT.getName(), "");
